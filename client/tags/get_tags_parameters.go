...
// WithTagText adds the tagText to the get tags params
func (o *GetTagsParams) WithTagText(tagText *string) *GetTagsParams {
	o.SetTagText(tagText)
	return o
}

// SetTagText adds the tagText to the get tags params
func (o *GetTagsParams) SetTagText(tagText *string) {
	o.TagText = tagText
}
...
func (o *GetTagsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.TagText != nil {
		...
		// query param tagText
		var qrTagText string
		if o.TagText != nil {
			qrTagText = *o.TagText
		}
		qTagText := qrTagText
		if qTagText != "" {
			if err := r.SetQueryParam("tagText", qTagText); err != nil {
				return err
			}
		}
